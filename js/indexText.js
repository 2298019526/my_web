(function(){
    var proverbTextArr = [
        ...
        "一个程序员在下班之前收到媳妇的短信：下班回来的路上买两屉包子回来，如果碰到卖西瓜的，就买一个。 该程序员只带回家一个包子，媳妇问为什么，答曰：因为路上碰到卖西瓜的了。",
        "某程序员对书法十分感兴趣，退休后决定在这方面有所建树。<br/>于是花重金购买了上等的文房四宝。<br/>一日，饭后突生雅兴，一番磨墨拟纸，<br/>并点上了上好的檀香，颇有王羲之风范，<br/>又具颜真卿气势，定神片刻，泼墨挥毫，<br/>郑重地写下一行字：Hello World. ",
        "这不是BUG是功能",
        "扫码提(改)需求，小本经营，恕不赊欠。",
        "世界上只有两句真理：<br/>1. 人一定会死。<br/>2. 程序一定有 Bug. ",
